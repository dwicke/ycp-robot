...
public class MessageCollection <MessageType> {
	...
	private TreeMap<Integer, MessageType> messages;
	...
	public MessageCollection(int numExpecting)
	{
		...
		messages = new TreeMap<Integer, MessageType>();
		
		curIndex = 0;
	}
	
	public Iterator<MessageType> receiveMessage(MessageType newMessage, int key)
	{
		...
		messages.put(curIndex, newMessage);
