...
(cl:defmethod cl:initialize-instance :after ((m <MotorData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-msg:<MotorData> is deprecated: use robot_msgs-msg:MotorData instead.")))

(cl:ensure-generic-function 'motor_left_velocity-val :lambda-list '(m))
(cl:defmethod motor_left_velocity-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:motor_left_velocity-val is deprecated.  Use robot_msgs-msg:motor_left_velocity instead.")
...
(cl:defmethod motor_left_time-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:motor_left_time-val is deprecated.  Use robot_msgs-msg:motor_left_time instead.")
  (motor_left_time m))

(cl:ensure-generic-function 'motor_right_velocity-val :lambda-list '(m))
(cl:defmethod motor_right_velocity-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:motor_right_velocity-val is deprecated.  Use robot_msgs-msg:motor_right_velocity instead.")
...
(cl:defmethod motor_right_time-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:motor_right_time-val is deprecated.  Use robot_msgs-msg:motor_right_time instead.")
  (motor_right_time m))
