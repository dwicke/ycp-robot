/* Auto-generated by genmsg_cpp for file /home/csuser/ros_workspace/ycp-robot/robot_msgs/msg/MotorData.msg */
#ifndef ROBOT_MSGS_MESSAGE_MOTORDATA_H
...
private:
  static const char* __s_getDataType_() { return "robot_msgs/MotorData"; }
public:
...
typedef boost::shared_ptr< ::robot_msgs::MotorData> MotorDataPtr;
typedef boost::shared_ptr< ::robot_msgs::MotorData const> MotorDataConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::robot_msgs::MotorData_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::robot_msgs::MotorData_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
struct MD5Sum< ::robot_msgs::MotorData_<ContainerAllocator> > {
  ...
  static const char* value(const  ::robot_msgs::MotorData_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x2c057021fd288de5ULL;
  static const uint64_t static_value2 = 0xb88a00bb6f218a61ULL;
};

template<class ContainerAllocator>
struct DataType< ::robot_msgs::MotorData_<ContainerAllocator> > {
  static const char* value() 
  {
    return "robot_msgs/MotorData";
  }
...
template<class ContainerAllocator>
struct Definition< ::robot_msgs::MotorData_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct IsFixedSize< ::robot_msgs::MotorData_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::robot_msgs::MotorData_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::robot_msgs::MotorData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::robot_msgs::MotorData_<ContainerAllocator> & v) 
  {
...
#endif // ROBOT_MSGS_MESSAGE_MOTORDATA_H
