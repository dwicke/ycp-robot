...
(cl:defmethod cl:initialize-instance :after ((m <MotorCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name MotorControlMsg-msg:<MotorCommand> is deprecated: use MotorControlMsg-msg:MotorCommand instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader MotorControlMsg-msg:header-val is deprecated.  Use MotorControlMsg-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'precedence-val :lambda-list '(m))
(cl:defmethod precedence-val ((m <MotorCommand>))
...
(cl:defmethod angular_velocity-val ((m <MotorCommand>))
